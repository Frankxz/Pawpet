...
class SignUpViewController_6: UIViewController, UITableViewDelegate, UITableViewDataSource {
...
// MARK: - UI + Constraints
extension SignUpViewController_6 {
    func setupViews() {
...
extension SignUpViewController_6: UISearchBarDelegate {
